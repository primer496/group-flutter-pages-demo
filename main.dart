...
static const List<TeamMember> members = [
  // 组长
  TeamMember(role: '组长', name: '胡玮明', task: '创建GitHub仓库、上传初始项目、审核所有PR、合并代码、发布GitHub Pages'),
  // 组员
  TeamMember(role: '组员A', name: '张景涛', task: '修改首页标题和项目口号'),
  TeamMember(role: '组员B', name: '李天宇', task: '完善小组成员信息与任务分工'),
  TeamMember(role: '组员C', name: '宋阳', task: '修改项目功能列表'),
  TeamMember(role: '组员D', name: '张春瑾', task: '修改页面内发布说明和访问地址'),
  TeamMember(role: '组员E', name: '徐冲', task: ' Flutter 页面主题与 UI 样式优化'),
  TeamMember(role: '组员F', name: '杨航', task: '仓库 README 文档编写与维护'),
];
